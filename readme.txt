...
Also please note that I didn't trained on whole data. Infact by using 4000 examples it got around 60% and with 80000 example it is about 97% accuracy. Each iteration takes lot of time.

While training please note that running the code will take about 30 mins.